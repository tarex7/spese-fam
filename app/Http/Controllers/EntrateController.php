        ...
        foreach ($entratePerCategoria as $spesa) {
            ...
            if ($mese != null) {
                ...
                for($i = 1;$i <= 12;$i++) {
                    ...
                    if(!isset($entrateRaggruppate[$categoria][$i])) {

                        $entrateRaggruppate[$categoria][$i] = 0;
                    }
                }
            }
        }
