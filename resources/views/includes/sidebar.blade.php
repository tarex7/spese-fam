            ...
            <!-- Menu Laterale -->
            <nav class="col-1 pl-1 bg-primary sidebar" style="height: 50vh;margin-top:1px;min-width:200px">
                <div class="position-sticky">
                    <ul class="nav flex-column py-4">
                        <li class="nav-item">
                            <a class="nav-link active text-white d-flex align-items-center" href="{{route('entrate')}}">
                                <i class="fa-solid fa-circle-dollar-to-slot mr-2"></i> <p class="m-0"> Entrate</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-white d-flex align-items-center" href="{{route('spese')}}">
                                <i class="fa-solid fa-hand-holding-dollar mr-2"></i> <p class="m-0"> Spese</p>
                            </a>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link active text-white d-flex align-items-center" href="{{route('categorie')}}">
                               <i class="fa-solid fa-list mr-2"></i> <p class="m-0"> Categorie spese</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-white d-flex align-items-center" href="{{route('categorie_entrate')}}">
